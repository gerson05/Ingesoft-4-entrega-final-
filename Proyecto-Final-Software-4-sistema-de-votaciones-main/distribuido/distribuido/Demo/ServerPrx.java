...
{
    default void processRequest(String clientId, String requestData)
    {
        processRequest(clientId, requestData, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void processRequest(String clientId, String requestData, java.util.Map<String, String> context)
    {
        _iceI_processRequestAsync(clientId, requestData, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> processRequestAsync(String clientId, String requestData)
    {
        return _iceI_processRequestAsync(clientId, requestData, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> processRequestAsync(String clientId, String requestData, java.util.Map<String, String> context)
    {
        return _iceI_processRequestAsync(clientId, requestData, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_processRequestAsync(String iceP_clientId, String iceP_requestData, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "processRequest", null, sync, null);
